...
void GifThresholdImage(const uint8_t *lastFrame, const uint8_t *nextFrame, uint8_t *outFrame, uint32_t width,
					   uint32_t height, GifPalette *pPal, uint8_t alphaThreshold) {
...
GifWriteLzwImage(FILE *f, uint8_t *image, uint32_t left, uint32_t top, uint32_t width, uint32_t height, uint32_t delay,
				 GifPalette *pPal, uint8_t transparent) {
...
bool GifWriteFrame(GifWriter *writer, const uint8_t *image, uint32_t width, uint32_t height, uint32_t delay,
				   int bitDepth, bool dither, uint8_t alphaThreshold) {
	if (!writer->f) return false;
...
bool
GifWriteFrame(GifWriter *writer, const uint8_t *image, uint32_t width, uint32_t height, uint32_t delay, GifPalette *pal,
			  int bitDepth, bool dither, uint8_t alphaThreshold) {
	if (!writer->f) return false;
